...
def main():
    ...
    parser.add_argument('--server', choices=['eu', 'us'], default='eu', 
                       help='Server region (eu/us)')
    ...
    create_parser.add_argument('--assign-vendor', action='store_true', 
                              help='Assign to vendor')
    ...
    attach_parser = project_subparsers.add_parser('attach', help='Attach document to project')
    ...
    addlang_parser = project_subparsers.add_parser('add-language', help='Add target language')
    ...
    doc_delete_parser.add_argument('--force', action='store_true', help='Skip confirmation')
    ...
    export_parser.add_argument('--type', choices=['target', 'xliff'], 
                              help='Export type (target/xliff)')
    
    # Document download
    download_parser = doc_subparsers.add_parser('download', help='Download export result')
    ...
    status_parser = doc_subparsers.add_parser('translate-status', help='Get translation status')
